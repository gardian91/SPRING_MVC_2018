...
/*	@RequestMapping(value = "pathVariableExample3", method = RequestMethod.GET)
	public String pathVariableExample3(@RequestParam(value = "id", required = false) String id,
	...
	/*	User user = userRepository.findOne(id);
		...
		if(user==null){
			throw new ResourceNotFoundException(id.toString(),"Resource with given id not exist");
		}*/
